...
geo <- geojsonio::geojson_read(file.geo, method="local", parse=TRUE, what="sp")
...
#### Load Household FuelType Usage Proportions by District
```{r tidy=TRUE}
...
#### Plot Choropleth Maps: Proportion of Households using FuelType
```{r fig.height = 7, fig.width = 7, fig.align = "center"}
