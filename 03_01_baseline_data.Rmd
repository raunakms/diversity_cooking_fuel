...
#### Get Proportion of Fuel Type in Total Population
```{r}
df <- dat %>% 
...
#### Plot Proportion by Fuel Type in Total Household
...
#### Get Proportion by Ethnicity, Income Group, and Fuel Type
```{r}
dm <- dat %>% 
...
#### Plot Household Proportion by Ethnicity, Income Group, and Fuel Type
...
#### Get Household Proportion by Ethnicity, Education Level, and Fuel Type
```{r}
dm <- dat %>% 
...
#### Plot Household Proportion by Ethnicity, Education Level, and Fuel Type
```{r fig.height = 4, fig.width = 8, fig.align = "center"}
# COLOR PALETTE ---
jColFun <- colorRampPalette(brewer.pal(n = 9, "Set1"))
...
#### Get Household Proportion by Ethnicity, Geo-climatic Region, and Fuel Type
```{r}
dm <- dat %>% 
...
#### Plot Household Proportion by Ethnicity, Geo-climatic Region, and Fuel Type
```{r fig.height = 4, fig.width = 8, fig.align = "center"}
# COLOR PALETTE ---
jColFun <- colorRampPalette(brewer.pal(n = 9, "Set1"))
...
#### Ethnic Household Population Distribution
```{r}
dm <- dat %>% 
...
#### Get Abundance by Ethnicity and Fuel Type
```{r}
...
#### Heatmap Total (Relative) Salce Abundance by Ethnicity and FuelType
```{r fig.align = "center"}
